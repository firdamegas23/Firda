        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="<?php echo e(route('index_input')); ?>"> <i class="menu-icon fa fa-briefcase"></i>Input </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
            ...
            <div class="animated fadeIn">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('add_register')); ?>" method="POST" class="register">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH D:\laragon\www\Belajar\resources\views/register.blade.php ENDPATH**/ ?>