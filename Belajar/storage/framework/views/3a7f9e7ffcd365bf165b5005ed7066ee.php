...
<body>
    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse"> <!-- /.navbar-collapse -->
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="Rebate"> <i class="menu-icon fa fa-briefcase"></i>Rebate </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
...
<?php /**PATH D:\laragon\www\Belajar\resources\views/rebate.blade.php ENDPATH**/ ?>