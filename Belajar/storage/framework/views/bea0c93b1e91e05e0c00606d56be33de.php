        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="<?php echo e(route('index_input')); ?>"> <i class="menu-icon fa fa-briefcase"></i>Input BL </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
                    ...
                    <div class="card-body" style="background-color: #fff;">
                        <table id="bootstrap-data-table" class="table table-striped table-bordered">
                            ...
                            <tbody> <!-- Isi Kolom -->
                                ...
                                <tr>
                                    <td class="text-center" style="vertical-align: middle"><?php echo e($loop->iteration); ?></td>
                                    <td style="vertical-align: middle"><?php echo e($Vendor_Rebate->BL_Name); ?></td>
                                    <td style="vertical-align: middle"><?php echo e($Vendor_Rebate->Brand); ?></td>
                                    <td style="vertical-align: middle"><?php echo e($Vendor_Rebate->Category); ?></td>
                                    <td style="vertical-align: middle"><?php echo e($Vendor_Rebate->Item_Code); ?></td>
                                    <td style="vertical-align: middle"><?php echo e($Vendor_Rebate->Program_Type); ?></td>
                                    <td style="vertical-align: middle"><?php echo e($Vendor_Rebate->Program_Code); ?></td>
                                    <td style="vertical-align: middle"><?php echo e($Vendor_Rebate->Program_Name); ?></td>
                                    <td style="vertical-align: middle"><?php echo e($Vendor_Rebate->Start_Date); ?></td>
                                    <td style="vertical-align: middle"><?php echo e($Vendor_Rebate->End_Date); ?></td>
                                    <td style="vertical-align: middle"><?php echo e($Vendor_Rebate->Qty); ?></td>
                                    <td style="vertical-align: middle"><?php echo e($Vendor_Rebate->Currency); ?></td>
                                    <td style="vertical-align: middle"><?php echo e($Vendor_Rebate->Incentive); ?></td>
                                    <td style="vertical-align: middle"><?php echo e($Vendor_Rebate->Notes); ?></td>
                                    <td class="text-center" style="vertical-align: middle">
                                        <a href="/edit_input/<?php echo e($Vendor_Rebate->Program_Code); ?>" class="" style="color: green">
                                            <i class="fa fa-pencil"></i> 
                                        </a> 
                                        &nbsp;
                                        <a href="/delete_input/<?php echo e($Vendor_Rebate->Program_Code); ?>" style="color: red" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');">
...
</html><?php /**PATH D:\laragon\www\Belajar\resources\views/index_input.blade.php ENDPATH**/ ?>