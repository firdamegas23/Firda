                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-caret-right"></i><a href="Izin Kerja">Izin Kerja</a></li>
                            <li><i class="fa fa-caret-right"></i><a href="Cuti">Cuti</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-caret-right"></i><a href="Kontrak Kerja">Kontrak Kerja</a></li>
                            <li><i class="fa fa-caret-right"></i><a href="Slip Gaji">Slip Gaji</a></li>
                            <li><i class="fa fa-caret-right"></i><a href="Pajak">Pajak</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="Kalender Perusahaan"> <i class="menu-icon fa fa-calendar"></i>Kalender Perusahaan</a>
                    </li>
                    <li class="menu-item-has-children dropdown">
                    ...
                    <li>
                        <a href="Pemberitahuan"> <i class="menu-icon fa fa-bell"></i>Pemberitahuan</a>
                    </li>
                    <li>
                        <a href="<?php echo e(Route('index_input')); ?>"> <i class="menu-icon fa fa-briefcase"></i>Rebate </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mx-auto d-block">
                            <img class="rounded-circle mx-auto d-block" src="images/Profil.png" alt="" style="text-align: center; width: 150px; height: 150px;">
                            <h5 class="text-sm-center mt-2 mb-1">Firda Mega Shafira</h5>
                            <div class="text-sm-center"><i class="fa fa-rocket"></i> IT</div>
                            <div class="text-sm-center">8 bulan</div>
                            <div class="text-sm-center"><li class="fa fa-phone">  0878123456789</li></div>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH D:\laragon\www\Belajar\resources\views/dashboard.blade.php ENDPATH**/ ?>