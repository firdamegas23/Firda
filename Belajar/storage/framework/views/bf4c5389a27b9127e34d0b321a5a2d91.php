            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title mb-3">VISION</strong>
                    </div>
                    <div class="card-body">
                        <div class="mx-auto d-block">
                            <h5 class="text-sm-center mt-2 mb-1">" Most Competitiveness Sales & Solution Company "</h5>
                        </div>
                    </div>    

                    <div class="card-header">
                        <strong class="card-title mb-3">MISION</strong>
                    </div>
                    <div class="card-body">
                        <div class="mx-auto d-block">
                            <div class="mx-auto d-bock">
                                <h5 class="text-sm-center mt-2 mb-1">" 3E "</h5>
                            </div>
                            <h6 class="text-sm-justify"><strong>Enlarge</strong> Product Line up : One Stop Solution for Customer</h6>
                            <h6 class="text-sm-justify mt-2 mb-1"><strong>Enhance</strong> Service & Solution : Customer Satisfaction</h6>
                            <h6 class="text-sm-justify mt-2 mb-1"><strong>Expand</strong> Channel Coverage : Customer Relationship Management</h6>
                        </div>
                    </div>   
                </div>
...
<?php /**PATH D:\laragon\www\Belajar\resources\views/profil_perusahaan.blade.php ENDPATH**/ ?>