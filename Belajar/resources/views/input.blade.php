        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <h3 class="menu-title">Register User</h3><!-- /.menu-title -->
                    <li>
                        <a href="{{ route('register') }}"><i class="menu-icon fa fa-code"></i>Register</a>
                    </li>  
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
                        ...
                        <table id="bootstrap-data-table" class="table table-striped table-bordered">
                            <thead class="text-center"> <!-- Judul Kolom -->
                                <tr class="text-center">
                                    ...
                                    <th style="vertical-align: middle">Datetime</th>
                            ...
                            <tbody> <!-- Isi Kolom -->
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align: middle">{{ $Vendor_Rebate->Record_DateTime}}</td>
                                    <td class="text-center" style="vertical-align: middle">
                                        <a href="/edit_input/{{ $Vendor_Rebate->Program_Code }}" class="btn btn-success btn-sm">
                                            <i class="fa fa-pencil"></i> 
                                        </a> 
                                        &nbsp;
                                        <a href="/delete_input/{{ $Vendor_Rebate->Program_Code }}" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');">
